...
export class InitSchema1747308332526 implements MigrationInterface {
    name = 'InitSchema1747308332526'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`status\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, \`billingAddressId\` int NULL, \`shippingAddressId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
